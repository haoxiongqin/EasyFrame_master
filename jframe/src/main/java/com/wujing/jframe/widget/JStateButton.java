 ...
 */
public class JStateButton extends AppCompatTextView {
    //text color
    ...
    public JStateButton(Context context) {
        this(context, null);
    }

    public JStateButton(Context context, AttributeSet attrs) {
        this(context, attrs, android.support.v7.appcompat.R.attr.buttonStyle);
    }

    public JStateButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setup(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.JStateButton);
        ...
        mNormalTextColor = a.getColor(R.styleable.JStateButton_normalTextColor, mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.JStateButton_pressedTextColor, mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.JStateButton_unableTextColor, mDefaultUnableTextColor);
        setTextColor();

        //set animation duration
        mDuration = a.getInteger(R.styleable.JStateButton_animationDuration, mDuration);
        mStateBackground.setEnterFadeDuration(mDuration);
        mStateBackground.setExitFadeDuration(mDuration);

        //set background color
        mNormalBackgroundColor = a.getColor(R.styleable.JStateButton_normalBackgroundColor, 0);
        mPressedBackgroundColor = a.getColor(R.styleable.JStateButton_pressedBackgroundColor, 0);
        mUnableBackgroundColor = a.getColor(R.styleable.JStateButton_unableBackgroundColor, 0);
        ...
        //set radius
        mRadius = a.getDimensionPixelSize(R.styleable.JStateButton_radius, 0);
        mRound = a.getBoolean(R.styleable.JStateButton_round, false);
        ...
        //set stroke
        mStrokeDashWidth = a.getDimensionPixelSize(R.styleable.JStateButton_strokeDashWidth, 0);
        mStrokeDashGap = a.getDimensionPixelSize(R.styleable.JStateButton_strokeDashWidth, 0);
        mNormalStrokeWidth = a.getDimensionPixelSize(R.styleable.JStateButton_normalStrokeWidth, 0);
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.JStateButton_pressedStrokeWidth, 0);
        mUnableStrokeWidth = a.getDimensionPixelSize(R.styleable.JStateButton_unableStrokeWidth, 0);
        mNormalStrokeColor = a.getColor(R.styleable.JStateButton_normalStrokeColor, 0);
        mPressedStrokeColor = a.getColor(R.styleable.JStateButton_pressedStrokeColor, 0);
        mUnableStrokeColor = a.getColor(R.styleable.JStateButton_unableStrokeColor, 0);
        setStroke();
