...
public class JToast {
    ...
    private static Context context= JFrame.getContext();
    ...
    public static Toast warning( @NonNull String message, int duration, boolean withIcon) {
        Drawable icon=null;
        if (withIcon){
            icon= JOutMethodUtils.getDrawable( R.drawable.jtoast_warning);
        }
    ...
    public static Toast info( @NonNull String message, int duration, boolean withIcon) {
        Drawable icon=null;
        if (withIcon){
            icon= JOutMethodUtils.getDrawable( R.drawable.jtoast_info);
        }
    ...
    public static Toast success( @NonNull String message, int duration, boolean withIcon) {
        Drawable icon=null;
        if (withIcon){
            icon= JOutMethodUtils.getDrawable( R.drawable.jtoast_success);
        }
    ...
    public static Toast error( @NonNull String message, int duration, boolean withIcon) {
        Drawable icon=null;
        if (withIcon){
            icon= JOutMethodUtils.getDrawable( R.drawable.jtoast_error);
        }
    ...
    public static Toast custom( @NonNull String message, @DrawableRes int iconRes,
        ...
        return custom( message, JOutMethodUtils.getDrawable( iconRes), textColor,tintColor, duration);
    }
    ...
    public static Toast custom( @NonNull String message, Drawable icon,
        ...
        JOutMethodUtils.setBackground(toastLayout, drawableFrame);

        if (icon == null){
            toastIcon.setVisibility(View.GONE);
        }else{
            JOutMethodUtils.setBackground(toastIcon, icon);
        }
