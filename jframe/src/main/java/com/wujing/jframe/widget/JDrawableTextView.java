 ...
 */
public class JDrawableTextView extends AppCompatTextView {
    ...
    public JDrawableTextView(Context context) {
        this(context, null);
    }

    public JDrawableTextView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    public JDrawableTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.JDrawableTextView);
        drawables[0] = array.getDrawable(R.styleable.JDrawableTextView_leftDrawable);
        drawables[1] = array.getDrawable(R.styleable.JDrawableTextView_topDrawable);
        drawables[2] = array.getDrawable(R.styleable.JDrawableTextView_rightDrawable);
        drawables[3] = array.getDrawable(R.styleable.JDrawableTextView_bottomDrawable);

        widths[0] = array.getDimensionPixelSize(R.styleable.JDrawableTextView_leftDrawableWidth, 0);
        widths[1] = array.getDimensionPixelSize(R.styleable.JDrawableTextView_topDrawableWidth, 0);
        widths[2] = array.getDimensionPixelSize(R.styleable.JDrawableTextView_rightDrawableWidth, 0);
        widths[3] = array.getDimensionPixelSize(R.styleable.JDrawableTextView_bottomDrawableWidth, 0);

        heights[0] = array.getDimensionPixelSize(R.styleable.JDrawableTextView_leftDrawableHeight, 0);
        heights[1] = array.getDimensionPixelSize(R.styleable.JDrawableTextView_topDrawableHeight, 0);
        heights[2] = array.getDimensionPixelSize(R.styleable.JDrawableTextView_rightDrawableHeight, 0);
        heights[3] = array.getDimensionPixelSize(R.styleable.JDrawableTextView_bottomDrawableHeight, 0);
