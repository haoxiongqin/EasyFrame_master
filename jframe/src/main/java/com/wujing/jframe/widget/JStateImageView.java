 ...
 */
public class JStateImageView extends AppCompatImageView {
    ...
    public JStateImageView(Context context) {
        this(context, null);
    }

    public JStateImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JStateImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.JStateImageView);

        mNormalDrawable = a.getDrawable(R.styleable.JStateImageView_normalBackground);
        mPressedDrawable = a.getDrawable(R.styleable.JStateImageView_pressedBackground);
        mUnableDrawable = a.getDrawable(R.styleable.JStateImageView_unableBackground);
        setStateBackground(mNormalDrawable, mPressedDrawable, mUnableDrawable);

        mDuration = a.getInteger(R.styleable.JStateImageView_animDuration, mDuration);
