...
public abstract class BaseQuickAdapter <T> extends BaseRecyclerViewAdapter<T,JViewHolder> {
    ...
    public BaseQuickAdapter(@NonNull RecyclerView mRecyclerView, List<T> dataLists){
        this(mRecyclerView,dataLists, -1);
    }
    public BaseQuickAdapter(@NonNull RecyclerView mRecyclerView, List<T> dataLists, @LayoutRes int layoutId) {
    ...
    protected abstract void bindData(JViewHolder holder, T data, int position);
    ...
    public BaseQuickAdapter<T> setOnLoadMoreListener(OnLoadMoreListener onLoadMoreListener) {
        this.onLoadMoreListener = onLoadMoreListener;
        return this;
    }
    public BaseQuickAdapter<T> setOnItemClickListener(OnItemClickListener onItemClickListener) {
        this.onItemClickListener = onItemClickListener;
        return this;
    }

    public BaseQuickAdapter<T> setOnItemLongClickListener(OnItemLongClickListener onItemLongClickListener) {
