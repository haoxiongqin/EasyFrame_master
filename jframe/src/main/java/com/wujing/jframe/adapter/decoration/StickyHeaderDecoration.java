package com.wujing.jframe.adapter.decoration;
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (!mIncludeHeader){
            if (parent.getAdapter() instanceof BaseQuickAdapter){
                int headerCount = ((BaseQuickAdapter) parent.getAdapter()).getHeaderCount();
                int footerCount = ((BaseQuickAdapter) parent.getAdapter()).getFooterCount();
                int dataCount = ((BaseQuickAdapter) parent.getAdapter()).getDataCount();
