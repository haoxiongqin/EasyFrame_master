...
public class JNetworkUtils {
     ...
     * @return 网络类型
     * <ul>
     * <li>{@link JNetworkUtils.NetworkType#NETWORK_WIFI   } </li>
     * <li>{@link JNetworkUtils.NetworkType#NETWORK_4G     } </li>
     * <li>{@link JNetworkUtils.NetworkType#NETWORK_3G     } </li>
     * <li>{@link JNetworkUtils.NetworkType#NETWORK_2G     } </li>
     * <li>{@link JNetworkUtils.NetworkType#NETWORK_UNKNOWN} </li>
     * <li>{@link JNetworkUtils.NetworkType#NETWORK_NO     } </li>
     * </ul>
     */
