...
public class JDensityUtils {
    ...
    public static int dp2px(float dpValue) {
        final float scale = JFrame.getDisplayMetrics().density;
    ...
    public static int sp2px(float spValue) {
        final float fontScale = JFrame.getDisplayMetrics().scaledDensity;
    ...
    public static int getScreenWidth() {
        return JFrame.getDisplayMetrics().widthPixels;
    }
    ...
    public static int getScreenHeight() {
        return JFrame.getDisplayMetrics().heightPixels;
    }
    ...
    public static int getScreenRealHeight() {
        int h;
        WindowManager winMgr = (WindowManager) JFrame.getSystemService(Context.WINDOW_SERVICE);
    ...
    public static int getStatusBarHeight() {
        ...
        try {
            ...
            statusBarHeight = JFrame.getResources().getDimensionPixelSize(x);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
    ...
    public static int getNavigationBarHeight() {
        ...
        Resources resources = JFrame.getResources();
