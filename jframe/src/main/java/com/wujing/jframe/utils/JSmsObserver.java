 ...
 */
public class JSmsObserver extends ContentObserver {
    public static final String SMS_URI_INBOX = "content://sms/inbox";
    private Activity activity = null;
    private String smsContent = "";
    private SmsListener listener;
    private String like;
    public JSmsObserver(Activity activity, Handler handler, String like, SmsListener listener) {
        super(handler);
    ...
    public void onChange(boolean selfChange) {
        ...
        if (cursor != null) {
            ...
            if (cursor.moveToFirst()) {
                ...
                if (!JEmptyUtils.isSpace(smsContent)) {
